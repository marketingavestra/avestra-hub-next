/* ─────────────────────────────────────────────────────
   TOOLS DETAIL DATA — conteúdo rico do drawer
   Importado dinamicamente em Directory.js
   (não entra no bundle principal — só carrega ao clicar)
   ───────────────────────────────────────────────────── */

export const TOOLS_DETAIL = {
  ...
  'Copiloto Jurídico Anual': {
    overview: `O plano mensal tem um teto de tokens. Pra quem usa pouco, nunca aparece.\n\nMas o advogado que usa o Copiloto todo dia, em todos os processos, começa a sentir o limite. É aí que o Anual faz sentido.\n\nR$ 1.997 uma vez. Tokens ilimitados. Suporte com prioridade. E toda vez que a Avestra lança um agente novo, você recebe antes de qualquer outra pessoa.\n\nA matemática é simples: dois meses de plano mensal custam mais que dois meses do Anual — e o Anual dura doze.`,
    howToUse: [
      { step: 1, title: 'Fale com a equipe', desc: 'Manda mensagem no WhatsApp. A equipe da Avestra te explica o processo de migração ou ativação — leva menos de 10 minutos.' },
      { step: 2, title: 'Migre seus casos em aberto', desc: 'Se você já tem o plano mensal, todos os seus casos e históricos migram automaticamente. Você não perde nada.' },
      { step: 3, title: 'Use sem olhar pro contador', desc: 'Com tokens ilimitados, você não precisa pensar se vai "gastar demais". Usa o Copiloto em todos os processos, sem restrição.' },
      { step: 4, title: 'Receba novos agentes primeiro', desc: 'Cada agente novo que a Avestra lança vai primeiro pra quem tem plano Anual. Você testa, dá feedback e já usa antes do mercado.' },
    ],
    tips: [
      { icon: '💡', title: 'Melhor custo-benefício pra uso intenso', desc: 'Quem usa o Copiloto em mais de 15 processos ativos por mês já sente o limite mensal. No Anual, não existe esse problema.' },
      { icon: '🔒', title: 'Pagamento único, acesso por 12 meses', desc: 'Sem cobrança mensal, sem surpresa no cartão. R$ 1.997 uma vez e você usa por um ano inteiro.' },
      { icon: '⚡', title: 'Suporte com prioridade real', desc: 'Clientes Anuais entram numa fila separada de suporte. Resposta em até 4 horas em dias úteis.' },
    ],
    prompts: [
      { label: 'Comparativo Mensal x Anual', text: 'Preciso entender se o plano Anual faz sentido pra mim. Hoje tenho [X] processos ativos e uso o Copiloto [Y] vezes por semana. Como calculo se vou atingir o limite mensal?' },
    ],
    pricing: {
      plans: [
        { name: 'Mensal', price: 'R$ 27/mês', highlight: false, features: ['6 agentes', 'Limite de tokens mensal', 'Suporte padrão'] },
        { name: 'Anual', price: 'R$ 1.997', highlight: true, features: ['Tudo do mensal', 'Tokens ilimitados', 'Suporte prioritário (4h)', 'Novos agentes em primeira mão'] },
      ]
    },
    alternatives: ['Copiloto Jurídico', 'ChatGPT Business', 'Claude for Work'],
  },

  'Mentoria com Dr. Wladmir': {
    overview: `Tem escritório que assina qualquer ferramenta e dois meses depois não usa. O problema não é a ferramenta. É que ninguém implementou.\n\nA Mentoria existe pra resolver exatamente isso. Dr. Wladmir Bonadio Filho (OAB/SP 398.640) e a equipe da Avestra entram no seu escritório — de forma remota ou presencial — e configuram o Copiloto pra funcionar do jeito que você trabalha.\n\nNão é um curso. Não é um grupo de WhatsApp com PDF. É implementação de verdade, com acompanhamento por 30 dias.`,
    howToUse: [
      { step: 1, title: 'Entrevista de diagnóstico', desc: 'Antes de qualquer coisa, a gente entende como você trabalha. Quais áreas atua, volume de processos, onde perde mais tempo, onde sente mais dor.' },
      { step: 2, title: 'Mapeamento de fluxos', desc: 'A equipe mapeia cada etapa do seu fluxo jurídico. Da captação do cliente até a entrega da peça. Aí a gente vê onde os agentes encaixam.' },
      { step: 3, title: 'Configuração personalizada', desc: 'Configuramos os 6 agentes com os parâmetros do seu escritório: sua área de atuação, seus tribunais, seu estilo de redação, suas teses.' },
      { step: 4, title: '30 dias de acompanhamento', desc: 'Você começa a usar. A gente acompanha, ajusta o que não está funcionando e garante que sua equipe está usando de verdade.' },
    ],
    tips: [
      { icon: '🎯', title: 'Não é pra todo mundo', desc: 'A Mentoria tem vagas limitadas. É pra advogados que querem implementação séria, não pra quem quer só comprar uma assinatura.' },
      { icon: '📈', title: 'ROI mensurável', desc: 'Escritórios que passaram pela implementação relatam redução de 60-70% no tempo de produção de peças nos primeiros 30 dias.' },
      { icon: '🤝', title: 'Acesso direto ao Dr. Wladmir', desc: 'Você tem acesso direto ao Dr. Wladmir durante o processo. Não tem intermediário, não tem gestor de conta. É o especialista na linha.' },
    ],
    prompts: [
      { label: 'Diagnóstico Inicial', text: 'Estou interessado na Mentoria. Meu escritório atua em [área]. Tenho [X] processos ativos. Hoje o maior gargalo é [problema]. Como funciona a implementação pra esse perfil?' },
    ],
    pricing: {
      plans: [
        { name: 'Mentoria Completa', price: 'R$ 5.000', highlight: true, features: ['Diagnóstico de fluxo', 'Configuração dos 6 agentes', '30 dias de acompanhamento', 'Acesso direto ao Dr. Wladmir', 'Inclui Copiloto Anual'] },
      ]
    },
    alternatives: ['Copiloto Jurídico', 'Copiloto Jurídico Anual'],
  },
